...
function reduceby20percent() {
  for (let letter in reducedListOfLetters) {
    ...
    probablityMap[entry] =
      Math.round((probablityMap[entry] - probablityMap[entry] * 0.2) * 100) /
      100;
  }
}
reduceby20percent();
...
var ivariable = 0;
var animatedText =
  "Place your ships by dragging and dropping them onto the battlefield. Double click to rotate a ship."; /* The text */
  ...
  if (ev.target.id == `smallShip`) {
    if (smallShip.attributes[5].nodeValue == `horizontal`) {
      ...
      if (firstPosition[0] == "A") {
        secondaryPosition = `A` + firstPosition.slice(1, firstPosition.length);
      ...
      } else if (firstPosition[0] == "J") {
        secondaryPosition = `J` + firstPosition.slice(1, firstPosition.length);
      }
      firstPosition = `${secondaryPosition.slice(0, 1)}${
        parseInt(secondaryPosition.slice(1, secondaryPosition.length)) - 1
      }`;
  ...
  // the big ship handling section
    ...
    if (bigShip.attributes[5].nodeValue == `horizontal`) {
      ...
      if (thirdPosition[0] == "A") {
        secondaryPosition = `A${
          parseInt(thirdPosition.slice(1, thirdPosition.length)) + 1
        }`;
        firstPosition = `A${
          parseInt(thirdPosition.slice(1, thirdPosition.length)) + 2
        }`;
        fourthPosition = `A${
          parseInt(thirdPosition.slice(1, thirdPosition.length)) - 1
        }`;
    ...
    // vertical
      ...
      if (secondaryPosition[0] == "B") {
        firstPosition =
          `A` + secondaryPosition.slice(1, secondaryPosition.length);
        thirdPosition =
          `C` + secondaryPosition.slice(1, secondaryPosition.length);
      } else if (secondaryPosition[0] == "C") {
        firstPosition =
          `B` + secondaryPosition.slice(1, secondaryPosition.length);
        thirdPosition =
          `D` + secondaryPosition.slice(1, secondaryPosition.length);
      } else if (secondaryPosition[0] == "D") {
        firstPosition =
          `C` + secondaryPosition.slice(1, secondaryPosition.length);
        thirdPosition =
          `E` + secondaryPosition.slice(1, secondaryPosition.length);
      } else if (secondaryPosition[0] == "E") {
        firstPosition =
          `D` + secondaryPosition.slice(1, secondaryPosition.length);
        thirdPosition =
          `F` + secondaryPosition.slice(1, secondaryPosition.length);
      } else if (secondaryPosition[0] == "F") {
        firstPosition =
          `E` + secondaryPosition.slice(1, secondaryPosition.length);
        thirdPosition =
          `G` + secondaryPosition.slice(1, secondaryPosition.length);
      } else if (secondaryPosition[0] == "G") {
        firstPosition =
          `F` + secondaryPosition.slice(1, secondaryPosition.length);
        thirdPosition =
          `H` + secondaryPosition.slice(1, secondaryPosition.length);
      } else if (secondaryPosition[0] == "H") {
        firstPosition =
          `G` + secondaryPosition.slice(1, secondaryPosition.length);
        thirdPosition =
          `I` + secondaryPosition.slice(1, secondaryPosition.length);
      } else if (secondaryPosition[0] == "I") {
        firstPosition =
          `H` + secondaryPosition.slice(1, secondaryPosition.length);
        thirdPosition =
          `J` + secondaryPosition.slice(1, secondaryPosition.length);
      }
...
function drop(ev) {
  ...
  if (data == `smallShip`) {
    if (smallShip.attributes[5].nodeValue == `horizontal`) {
      ...
      let secondpos = `${firstpos.slice(0, 1)}${
        parseInt(firstpos.slice(1, firstpos.length)) - 1
      }`;
      if (
        document.getElementById(firstpos).attributes[4].value == `true` ||
    ...
    // vertical
      ...
      let firstpos = ev.path[0].id;
      let secondpos;
      if (firstpos.slice(0, 1) == `A`) {
        secondpos = `B${firstpos.slice(1, firstpos.length)}`;
      } else if (firstpos.slice(0, 1) == `B`) {
        secondpos = `C${firstpos.slice(1, firstpos.length)}`;
      } else if (firstpos.slice(0, 1) == `C`) {
        secondpos = `D${firstpos.slice(1, firstpos.length)}`;
      } else if (firstpos.slice(0, 1) == `D`) {
        secondpos = `E${firstpos.slice(1, firstpos.length)}`;
      } else if (firstpos.slice(0, 1) == `E`) {
        secondpos = `F${firstpos.slice(1, firstpos.length)}`;
      } else if (firstpos.slice(0, 1) == `F`) {
        secondpos = `G${firstpos.slice(1, firstpos.length)}`;
      } else if (firstpos.slice(0, 1) == `G`) {
        secondpos = `H${firstpos.slice(1, firstpos.length)}`;
      } else if (firstpos.slice(0, 1) == `H`) {
        secondpos = `I${firstpos.slice(1, firstpos.length)}`;
      } else if (firstpos.slice(0, 1) == `I`) {
        secondpos = `J${firstpos.slice(1, firstpos.length)}`;
      }
      if (
        document.getElementById(firstpos).attributes[4].value == `true` ||
        document.getElementById(secondpos).attributes[4].value == `true`
  ...
  if (data == `fourLongShip`) {
    if (fourLongShip.attributes[5].nodeValue == `horizontal`) {
      ...
      firstpos = `${thirdpos.slice(0, 1)}${
        parseInt(thirdpos.slice(1, thirdpos.length)) + 2
      }`;
      secondpos = `${thirdpos.slice(0, 1)}${
        parseInt(thirdpos.slice(1, thirdpos.length)) + 1
      }`;
      fourthpos = `${thirdpos.slice(0, 1)}${
        parseInt(thirdpos.slice(1, thirdpos.length)) - 1
      }`;
  ...
  if (data == `threeShipOne`) {
    if (threeShipOne.attributes[5].nodeValue == `horizontal`) {
      ...
      firstpos = `${secondpos.slice(0, 1)}${
        parseInt(secondpos.slice(1, secondpos.length)) + 1
      }`;
      thirdpos = `${secondpos.slice(0, 1)}${
        parseInt(secondpos.slice(1, secondpos.length)) - 1
      }`;
  ...
  if (
    ev.path[0].id == `smallShip` ||
    ev.path[0].id == `fourLongShip` ||
    ev.path[0].id == `biggestShip` ||
    ev.path[0].id == `threeShipOne` ||
    ev.path[0].id == `threeShipTwo`
  ) {
  } else {
    if (data == `smallShip`) {
      // if horizontal
        ...
        } else if (ev.path[0].id != `smallShip`) {
          {
            ...
            for (ship in lastShipLocations) {
              if (lastShipLocations.length > 0) {
                if (lastShipLocations[ship]) {
                  ...
                  document
                    .getElementById(lastShipLocations[ship])
                    .setAttribute(`shiphere`, false);
                }
              }
            }
            // all of the past locations are being removed here
            for (locations in lastShipLocations) {
              lastShipLocations.pop();
            }
            ...
            if (!getSmallShipSecondaryPositionDragWrapper(ev)) {
              ...
              if (ev.target.id[1] == "1" && ev.target.id[2] != 0) {
                ...
                smallShip.style.transform =
                  "rotate(90deg) translateY(20px) translateX(-20px)";
              }
            }
          }
        } else {
    ...
    if (data == `biggestShip`) {
      ...
      // Vertical
        ...
        // marking the past locations false
        if (
          ev.target.id.slice(0, 1) == `J` ||
          ev.target.id.slice(0, 1) == `I` ||
          ev.target.id.slice(0, 1) == `A` ||
          ev.target.id.slice(0, 1) == `B`
        ) {
          return false;
        }
        if (ev.path[1] != lastShipLocations[0]) {
...
function getThreeLongShipTwoSecondaryPositionDragWrapper(ev) {
  if (threeShipTwo.attributes[5].nodeValue == `vertical`) {
    ...
    if (
      document.getElementById(secondaryPosition).attributes[4].value ==
        `true` ||
  ...
  if (smallShip.attributes[5].nodeValue == `vertical`) {
    ...
    if (
      ...
      if (secondaryPosition) {
        ev.target.setAttribute(`shiphere`, true);
        document
          .getElementById(secondaryPosition)
          .setAttribute(`shiphere`, true);
...
function returnSecondaryPostitionForHorizontalSmallShip(ev) {
  ...
  let secondaryPosition = "";
  if (firstPosition[0] == "A") {
    secondaryPosition = `A${firstPosition.slice(1, firstPosition.length) - 1}`;
  } else if (firstPosition[0] == "B") {
    secondaryPosition = `B${firstPosition.slice(1, firstPosition.length) - 1}`;
  } else if (firstPosition[0] == "C") {
    secondaryPosition = `C${firstPosition.slice(1, firstPosition.length) - 1}`;
  } else if (firstPosition[0] == "D") {
    secondaryPosition = `D${firstPosition.slice(1, firstPosition.length) - 1}`;
  } else if (firstPosition[0] == "E") {
    secondaryPosition = `E${firstPosition.slice(1, firstPosition.length) - 1}`;
  } else if (firstPosition[0] == "F") {
    secondaryPosition = `F${firstPosition.slice(1, firstPosition.length) - 1}`;
  } else if (firstPosition[0] == "G") {
    secondaryPosition = `G${firstPosition.slice(1, firstPosition.length) - 1}`;
  } else if (firstPosition[0] == "H") {
    secondaryPosition = `H${firstPosition.slice(1, firstPosition.length) - 1}`;
  } else if (firstPosition[0] == "I") {
    secondaryPosition = `I${firstPosition.slice(1, firstPosition.length) - 1}`;
  } else if (firstPosition[0] == "J") {
    secondaryPosition = `J${firstPosition.slice(1, firstPosition.length) - 1}`;
  }
...
function rotatethreeShipOne() {
  if (threeShipOne.attributes[5].nodeValue == `vertical`) {
    ...
    if (threeShipOne.parentElement.id[0] == `B`) {
      firstPosition = `A${parseInt(
        threeShipOne.parentElement.id.slice(
          1,
          threeShipOne.parentElement.id.length
        )
      )}`;
    } else if (threeShipOne.parentElement.id[0] == `C`) {
      firstPosition = `B${parseInt(
        threeShipOne.parentElement.id.slice(
          1,
          threeShipOne.parentElement.id.length
        )
    ...
    if (
      parseInt(firstPosition.slice(1, firstPosition.length)) > 9 ||
      parseInt(firstPosition.slice(1, firstPosition.length)) < 2
    ) {
    ...
    if (firstPosition[0] == "A") {
      rotatedPosition = `B${
        parseInt(firstPosition.slice(1, firstPosition.length)) + 1
      }`;
      secondaryPosition = `B${parseInt(
        firstPosition.slice(1, firstPosition.length)
      )}`;
      thirdPosition = `B${
        parseInt(firstPosition.slice(1, firstPosition.length)) - 1
      }`;
    ...
    if (
      ...
      document
        .getElementById(`${firstPosition}`)
        .setAttribute(`shiphere`, true);
      document
        .getElementById(`${secondaryPosition}`)
        .setAttribute(`shiphere`, true);
      document
        .getElementById(`${thirdPosition}`)
        .setAttribute(`shiphere`, true);
    ...
    if (threeShipOne.parentElement.parentElement.id == `gridContainer`) {
      ...
      document
        .getElementById(secondaryPosition)
        .appendChild(document.getElementById(`threeShipOne`));
    ...
    if (firstPosition.slice(0, 1) == `A`) {
      secondaryPosition = `A${parseInt(
        firstPosition.slice(1, firstPosition.length) - 1
      )}`;
      thirdPosition = `A${parseInt(
        firstPosition.slice(1, firstPosition.length) - 2
      )}`;
    }
    if (firstPosition.slice(0, 1) == `B`) {
      ...
      thirdPosition = `I${parseInt(
        firstPosition.slice(1, firstPosition.length) - 2
      )}`;
    }
    if (
      !document.getElementById(`${firstPosition}`) ||
    ...
    if (
      ...
      console.log(secondaryPosition);
      firstPosition = `${secondaryPosition[0]}${
        parseInt(secondaryPosition.slice(1, secondaryPosition.length)) + 1
      }`;
      thirdPosition = `${secondaryPosition[0]}${
        parseInt(secondaryPosition.slice(1, secondaryPosition.length)) - 1
      }`;
      console.log(firstPosition);
      document.getElementById(firstPosition).attributes[4].value = `true`;
...
function rotatethreeShipTwo() {
  if (threeShipTwo.attributes[5].nodeValue == `vertical`) {
    ...
    if (threeShipTwo.parentElement.id[0] == `B`) {
      firstPosition = `A${parseInt(
        threeShipTwo.parentElement.id.slice(
          1,
          threeShipTwo.parentElement.id.length
        )
      )}`;
    ...
    if (threeShipTwo.parentElement.parentElement.id == `gridContainer`) {
      ...
      document
        .getElementById(secondaryPosition)
        .appendChild(document.getElementById(`threeShipTwo`));
...
function rotatefourLongShip() {
  if (fourLongShip.attributes[5].nodeValue == `vertical`) {
    ...
    if (fourLongShip.parentElement.id[0] == `C`) {
      firstPosition = `A${parseInt(
        fourLongShip.parentElement.id.slice(
          1,
          fourLongShip.parentElement.id.length
        )
      )}`;
    ...
    if (
      parseInt(firstPosition.slice(1, firstPosition.length)) > 8 ||
      parseInt(firstPosition.slice(1, firstPosition.length)) < 2
    ) {
      console.log(`Out of bounds rotation`);
      return false;
    ...
    if (fourLongShip.parentElement.parentElement.id == `gridContainer`) {
      ...
      document
        .getElementById(thirdPosition)
        .appendChild(document.getElementById(`fourLongShip`));
      fourLongShip.style.transform =
        "rotate(90deg) translateX(-60px) translateY(-20px)";
    ...
    if (firstPosition.slice(0, 1) == `C`) {
      ...
      fourthPosition = `C${parseInt(
        firstPosition.slice(1, firstPosition.length) - 3
      )}`;
    } else if (firstPosition.slice(0, 1) == `D`) {
      secondaryPosition = `D${parseInt(
        firstPosition.slice(1, firstPosition.length) - 1
      )}`;
      fourthPosition = `D${parseInt(
        firstPosition.slice(1, firstPosition.length) - 3
      )}`;
    } else if (firstPosition.slice(0, 1) == `E`) {
      secondaryPosition = `E${parseInt(
    ...
    if (
      ...
      console.log(thirdPosition);
      firstPosition = `${thirdPosition[0]}${
        parseInt(thirdPosition.slice(1, thirdPosition.length)) + 2
      }`;
      secondaryPosition = `${thirdPosition[0]}${
        parseInt(thirdPosition.slice(1, thirdPosition.length)) + 1
      }`;
      fourthPosition = `${thirdPosition[0]}${
        parseInt(thirdPosition.slice(1, thirdPosition.length)) - 1
      }`;
      console.log(firstPosition);
      document.getElementById(firstPosition).attributes[4].value = `true`;
...
function rotateBigShip() {
  if (bigShip.attributes[5].nodeValue == `vertical`) {
    ...
    if (bigShip.parentElement.id[0] == `C`) {
      firstPosition = `A${parseInt(
        bigShip.parentElement.id.slice(1, bigShip.parentElement.id.length)
      )}`;
    ...
    if (
      parseInt(firstPosition.slice(1, firstPosition.length)) > 8 ||
      parseInt(firstPosition.slice(1, firstPosition.length)) < 3
    ) {
      console.log(`Out of bounds rotation`);
      return false;
    }
    ...
    if (bigShip.parentElement.parentElement.id == `gridContainer`) {
      ...
      document
        .getElementById(thirdPosition)
        .appendChild(document.getElementById(`biggestShip`));
    ...
    if (firstPosition.slice(0, 1) == `C`) {
      ...
      fifthPosition = `C${parseInt(
        firstPosition.slice(1, firstPosition.length) - 4
      )}`;
    } else if (firstPosition.slice(0, 1) == `D`) {
      secondaryPosition = `D${parseInt(
        firstPosition.slice(1, firstPosition.length) - 1
    ...
    if (
      ...
      !document.getElementById(
        `${fourthPosition}` || !document.getElementById(`${fifthPosition}`)
      )
    ) {
      return false;
    }
...
function rotateSmallestShip() {
  ...
  if (
    ...
    smallShip.parentElement.id[0] == `A`
  ) {
    return false;
  }
  if (firstPosition[0] == "A") {
  ...
  if (round > 0) {
    ...
    rotatedPosition = `${secondaryPosition.slice(0, 1)}${
      parseInt(secondaryPosition.slice(1, secondaryPosition.length)) + 1
    }`;
  }
  //}
  ...
  if (smallShip.attributes[5].nodeValue == `vertical`) {
    ...
    // if it's not still in the dock
      ...
      if (
        ...
        document
          .getElementById(rotatedPosition)
          .appendChild(document.getElementById(`smallShip`));
        smallShip.style.transform =
          "rotate(90deg) translateY(20px) translateX(-20px)";
        smallShip.attributes[5].nodeValue = `horizontal`;
      }
    ...
    secondaryPosition = `${firstPosition.slice(0, 1)}${
      parseInt(firstPosition.slice(1, firstPosition.length)) - 1
    }`;
    // to be kept true
    if (secondaryPosition.slice(0, 1) == `B`) {
      rotatedPosition = `${`A`}${parseInt(
        secondaryPosition.slice(1, secondaryPosition.length)
      )}`;
    } else if (secondaryPosition.slice(0, 1) == `C`) {
      rotatedPosition = `${`B`}${parseInt(
        secondaryPosition.slice(1, secondaryPosition.length)
      )}`;
    } else if (secondaryPosition.slice(0, 1) == `D`) {
      rotatedPosition = `${`C`}${parseInt(
        secondaryPosition.slice(1, secondaryPosition.length)
      )}`;
    } else if (secondaryPosition.slice(0, 1) == `E`) {
      rotatedPosition = `${`D`}${parseInt(
        secondaryPosition.slice(1, secondaryPosition.length)
      )}`;
    } else if (secondaryPosition.slice(0, 1) == `F`) {
      rotatedPosition = `${`E`}${parseInt(
        secondaryPosition.slice(1, secondaryPosition.length)
      )}`;
    } else if (secondaryPosition.slice(0, 1) == `G`) {
      rotatedPosition = `${`F`}${parseInt(
        secondaryPosition.slice(1, secondaryPosition.length)
      )}`;
    } else if (secondaryPosition.slice(0, 1) == `H`) {
      rotatedPosition = `${`G`}${parseInt(
        secondaryPosition.slice(1, secondaryPosition.length)
      )}`;
    } else if (secondaryPosition.slice(0, 1) == `I`) {
      rotatedPosition = `${`H`}${parseInt(
        secondaryPosition.slice(1, secondaryPosition.length)
      )}`;
    } else if (secondaryPosition.slice(0, 1) == `J`) {
      rotatedPosition = `${`I`}${parseInt(
        secondaryPosition.slice(1, secondaryPosition.length)
      )}`;
    }
...
function chooseEnemyTwoShipLocation() {
  ...
  while (clearPath == false) {
    ...
    if (orient == `vertical`) {
      ...
      TwoShipFirst = start;
      TwoShipSecond = `${start.slice(0, 1)}${
        parseInt(start.slice(1, start.length)) - 1
      }`;
    }
    ...
    if (
      `${document.getElementById(TwoShipFirst).attributes[2].value}` == `true`
    ) {
    } else if (
      `${document.getElementById(TwoShipSecond).attributes[2].value}` == `true`
    ) {
    } else {
      clearPath = true;
    }
...
function chooseEnemyThreeShipLocation() {
  ...
  while (clearPath == false) {
    ...
    if (orient == `vertical`) {
      ...
      while (
        ...
        start.slice(1, start.length) == `2`
      ) {
        start = chooseRandomGridPoint();
      }
      ThreeShipFirst = start;
      ThreeShipSecond = `${start.slice(0, 1)}${
        parseInt(start.slice(1, start.length)) - 1
      }`;
      ThreeShipThird = `${start.slice(0, 1)}${
        parseInt(start.slice(1, start.length)) - 2
      }`;
    }
    ...
    if (
      `${document.getElementById(ThreeShipFirst).attributes[2].value}` == `true`
    ) {
    } else if (
      `${document.getElementById(ThreeShipSecond).attributes[2].value}` ==
      `true`
    ) {
    } else if (
      `${document.getElementById(ThreeShipThird).attributes[2].value}` == `true`
    ) {
    } else {
      clearPath = true;
    }
  ...
  if (shipcounter == 0) {
    ...
    document
      .getElementById(ThreeShipSecond)
      .setAttribute(`shiptype`, `cruiser`);
...
function chooseEnemyFourShipLocation() {
  ...
  while (clearPath == false) {
    ...
    if (orient == `vertical`) {
      ...
      while (
        start.slice(1, start.length) == `1` ||
        start.slice(1, start.length) == `2` ||
        start.slice(1, start.length) == `3`
      ) {
        start = chooseRandomGridPoint();
      }
      FourShipFirst = start;
      FourShipSecond = `${start.slice(0, 1)}${
        parseInt(start.slice(1, start.length)) - 1
      }`;
      FourShipThird = `${start.slice(0, 1)}${
        parseInt(start.slice(1, start.length)) - 2
      }`;
      FourShipFourth = `${start.slice(0, 1)}${
        parseInt(start.slice(1, start.length)) - 3
      }`;
    }
    ...
    if (
      `${document.getElementById(FourShipFirst).attributes[2].value}` == `true`
    ) {
    } else if (
      `${document.getElementById(FourShipSecond).attributes[2].value}` == `true`
    ) {
    } else if (
      `${document.getElementById(FourShipThird).attributes[2].value}` == `true`
    ) {
    } else if (
      `${document.getElementById(FourShipFourth).attributes[2].value}` == `true`
    ) {
    } else {
      clearPath = true;
    }
  ...
  document
    .getElementById(FourShipSecond)
    .setAttribute(`shiptype`, `battleship`);
  document.getElementById(FourShipThird).setAttribute(`shiptype`, `battleship`);
  document
    .getElementById(FourShipFourth)
    .setAttribute(`shiptype`, `battleship`);
...
function chooseEnemyLongShipLocation() {
  ...
  if (orient == `vertical`) {
    ...
    while (
      ...
      start.slice(1, start.length) == `2` ||
      start.slice(1, start.length) == `3` ||
      start.slice(1, start.length) == `4`
    ) {
      start = chooseRandomGridPoint();
    }
    bigShipFirst = start;
    bigShipSecond = `${start.slice(0, 1)}${
      parseInt(start.slice(1, start.length)) - 1
    }`;
    bigShipThird = `${start.slice(0, 1)}${
      parseInt(start.slice(1, start.length)) - 2
    }`;
    bigShipFourth = `${start.slice(0, 1)}${
      parseInt(start.slice(1, start.length)) - 3
    }`;
    bigShipFifth = `${start.slice(0, 1)}${
      parseInt(start.slice(1, start.length)) - 4
    }`;
  }
  ...
  for (let shipps in shipCenters) {
    ...
    if (imgsrc == `space_carrier.png`) {
      if (orientation == `vertical`) {
        ...
        longShip1 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
            )
          ) + 2
        }`;
        longShip2 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
        ...
        longShip3 = `${shipCenters[shipps].parentNode.id}`;
        longShip4 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
        ...
        longShip5 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
    ...
    if (imgsrc == `Spaceship_tut_thin.png`) {
      if (orientation == `vertical`) {
        ...
        fourlongShip1 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
        ...
        fourlongShip2 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
        ...
        fourlongShip3 = `${shipCenters[shipps].parentNode.id}`;
        fourlongShip4 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
    ...
    if (imgsrc == `shiper_mix_02.png`) {
      if (orientation == `vertical`) {
        ...
        threelongShip1 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
        ...
        threelongShip2 = `${shipCenters[shipps].parentNode.id}`;
        threelongShip3 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
    ...
    if (imgsrc == `ship9.png`) {
      if (orientation == `vertical`) {
        ...
        if (three2longShip2.slice(0, 1) == `B`) {
          three2longShip1 = `A${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
          three2longShip3 = `C${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
        }
        if (three2longShip2.slice(0, 1) == `C`) {
          three2longShip1 = `B${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
          three2longShip3 = `D${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
        }
        if (three2longShip2.slice(0, 1) == `D`) {
          three2longShip1 = `C${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
          three2longShip3 = `E${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
        }
        if (three2longShip2.slice(0, 1) == `E`) {
          three2longShip1 = `D${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
          three2longShip3 = `F${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
        }
        if (three2longShip2.slice(0, 1) == `F`) {
          three2longShip1 = `E${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
          three2longShip3 = `G${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
        }
        if (three2longShip2.slice(0, 1) == `G`) {
          three2longShip1 = `F${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
          three2longShip3 = `H${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
        }
        if (three2longShip2.slice(0, 1) == `H`) {
          three2longShip1 = `G${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
          three2longShip3 = `I${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
        }
        if (three2longShip2.slice(0, 1) == `I`) {
          three2longShip1 = `H${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
          three2longShip3 = `J${three2longShip2.slice(
            1,
            three2longShip2.length
          )}`;
        }
      } else if (orientation == `horizontal`) {
        three2longShip1 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
        ...
        three2longShip2 = `${shipCenters[shipps].parentNode.id}`;
        three2longShip3 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
    ...
    if (imgsrc == `antmaker.png`) {
      if (orientation == `vertical`) {
        ...
        twolongship2 = `${shipCenters[shipps].parentNode.id.slice(0, 1)}${
          parseInt(
            shipCenters[shipps].parentNode.id.slice(
              1,
              shipCenters[shipps].parentNode.id.length
...
function startGame() {
  ...
  var ivariable = 0;
  var animatedText2 =
    "The war has begun... the enemy ships have picked their positions."; /* The text */
  var speed = 40; /* The speed/duration of the effect in milliseconds */
  ...
  function typeWriter2() {
    if (useTyperWriter == true) {
      if (ivariable < animatedText2.length) {
        document.getElementById("message").innerHTML +=
          animatedText2.charAt(ivariable);
        ivariable++;
  ...
  function typeWriter3() {
    if (useTyperWriter == true) {
      if (xvariable < animatedText3.length) {
        document.getElementById("message").innerHTML +=
          animatedText3.charAt(xvariable);
    ...
    function typeWriter4() {
      if (useTyperWriter == true) {
        if (yvariable < animatedText4.length) {
          document.getElementById("message").innerHTML +=
            animatedText4.charAt(yvariable);
    ...
    function typeWriter4() {
      if (useTyperWriter == true) {
        if (dvariable < animatedText7.length) {
          document.getElementById("message").innerHTML +=
            animatedText7.charAt(dvariable);
    ...
    function typeWriter5() {
      if (useTyperWriter == true) {
        if (zvariable < animatedText5.length) {
          document.getElementById("message").innerHTML +=
            animatedText5.charAt(zvariable);
    ...
    function typeWriter10() {
      if (useTyperWriter == true) {
        if (zvariablez < animatedText10.length) {
          document.getElementById("message").innerHTML +=
            animatedText10.charAt(zvariablez);
    ...
    function typeWriter6() {
      if (useTyperWriter == true) {
        if (wvariable < animatedText6.length) {
          document.getElementById("message").innerHTML +=
            animatedText6.charAt(wvariable);
    ...
    function typeWriter9() {
      if (useTyperWriter == true) {
        if (avariable < animatedText9.length) {
          document.getElementById("message").innerHTML +=
            animatedText9.charAt(avariable);
  ...
  function findPotentialTargets(enemyChoice) {
    ...
    if (hitPosition.slice(1, hitPosition.length) == `10`) {
      ...
      rightPosition = `${hitPosition.slice(0, 1)}${
        parseInt(hitPosition.slice(1, hitPosition.length)) + 1
      }`;
    }

    if (hitPosition.slice(1, hitPosition.length) == `1`) {
    } else {
      leftPosition = `${hitPosition.slice(0, 1)}${
        parseInt(hitPosition.slice(1, hitPosition.length)) - 1
      }`;
    }
  ...
  function updateProbMapOnMiss(missSpace) {
    ...
    let waveRight1 = `${missSpace.id.slice(0, 1)}${
      parseInt(missSpace.id.slice(1, missSpace.length)) + 1
    }`;
    let waveRight2 = `${missSpace.id.slice(0, 1)}${
      parseInt(missSpace.id.slice(1, missSpace.length)) + 2
    }`;
    let waveRight3 = `${missSpace.id.slice(0, 1)}${
      parseInt(missSpace.id.slice(1, missSpace.length)) + 3
    }`;
    let waveRight4 = `${missSpace.id.slice(0, 1)}${
      parseInt(missSpace.id.slice(1, missSpace.length)) + 4
    }`;
    let waveLeft1 = `${missSpace.id.slice(0, 1)}${
      parseInt(missSpace.id.slice(1, missSpace.length)) - 1
    }`;
    let waveLeft2 = `${missSpace.id.slice(0, 1)}${
      parseInt(missSpace.id.slice(1, missSpace.length)) - 2
    }`;
    let waveLeft3 = `${missSpace.id.slice(0, 1)}${
      parseInt(missSpace.id.slice(1, missSpace.length)) - 3
    }`;
    let waveLeft4 = `${missSpace.id.slice(0, 1)}${
      parseInt(missSpace.id.slice(1, missSpace.length)) - 4
    }`;
    ...
    for (let letter in listOfLetters) {
      ...
      if (
        ...
        probablityMap[entry] =
          Math.round(
            (probablityMap[entry] - probablityMap[entry] * 0.3075) * 100
          ) / 100;
      } else if (
        entry == waveRight2 ||
        entry == waveLeft2 ||
        ...
        probablityMap[entry] =
          Math.round(
            (probablityMap[entry] - probablityMap[entry] * 0.176) * 100
          ) / 100;
      } else if (
        entry == waveRight3 ||
        entry == waveLeft3 ||
        ...
        probablityMap[entry] =
          Math.round(
            (probablityMap[entry] - probablityMap[entry] * 0.065) * 100
          ) / 100;
      } else if (
        entry == waveRight4 ||
        entry == waveLeft4 ||
        ...
        probablityMap[entry] =
          Math.round(
            (probablityMap[entry] + probablityMap[entry] * 0.0057) * 100
          ) / 100;
      } else {
        probablityMap[entry] =
          Math.round(
            (probablityMap[entry] + probablityMap[entry] * 0.038) * 10
          ) / 10;
      }
    }
  }
  ...
  function checkLongShipSunk() {
    ...
    for (let position in longShipFinalPositions) {
      if (
        document.getElementById(`${longShipFinalPositions[position]}`)
          .attributes[5] != undefined
      ) {
        longshiphhitCounter++;
      }
    }
  ...
  function checkfourLongShipSunk() {
    ...
    for (let position in fourlongShipFinalPositions) {
      if (
        document.getElementById(`${fourlongShipFinalPositions[position]}`)
          .attributes[5] != undefined
      ) {
  ...
  function checkthree1LongShipSunk() {
    ...
    for (let position in threelong1ShipFinalPositions) {
      if (
        document.getElementById(`${threelong1ShipFinalPositions[position]}`)
          .attributes[5] != undefined
      ) {
  ...
  function checkthree2LongShipSunk() {
    ...
    for (let position in threelong2ShipFinalPositions) {
      if (
        document.getElementById(`${threelong2ShipFinalPositions[position]}`)
          .attributes[5] != undefined
      ) {
  ...
  function checktwo2LongShipSunk() {
    ...
    for (let position in twolongShipFinalPositions) {
      if (
        document.getElementById(`${twolongShipFinalPositions[position]}`)
          .attributes[5] != undefined
      ) {
